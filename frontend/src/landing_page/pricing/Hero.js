            ...
            <div className='text-center'>
             ...
             <div className='row p-5' style={{marginBottom:"-50px"}}>
                <div className='col-4 p-5 text-center'>
                    <img src='media/images/pricing-eq.svg' alt='pricing-eq Img' style={{width:"70%"}}/>
                ...
                <div className='col-4 p-4 text-center' style={{marginTop:"20px"}}>
                    <img src='media/images/Free direct MF.svg' alt='Free direct MF' style={{width:"60%"}}/>
                ...
                <div className='col-4 p-5 text-center'>
                    <img src='media/images/pricing-eq.svg' alt='Free direct MF Img' style={{width:"70%"}}/>
