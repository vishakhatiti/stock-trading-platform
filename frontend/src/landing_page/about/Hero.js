...
function Hero() {
  return (
    <div className="container">
      <div className="row">
        <h1 className="fs-4 text-center mt-5 mt-5">
          We pioneered the discount broking model in India. <br />
          Now, we are breaking ground with our technology.
        </h1>
      </div>

      <div className="row p-5 mt-5 border-top text-muted fs-6" style={{lineHeight:"1.9", fontSize:"1.2em"}}>
        ...
        <div className="col-6 p-5">
          <p>
            ...
            about us or learn more about our business and product philosop</p>
        </div>
      </div>
    </div>
  );
